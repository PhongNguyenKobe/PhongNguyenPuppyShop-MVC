...
namespace PhongNguyenPuppy_MVC.Controllers
{
    public class HangHoasController : Controller
    {
        ...
        public HangHoasController(PhongNguyenPuppyContext context)
        {
            _context = context;
        }
        ...
        {
            var phongNguyenPuppyContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await phongNguyenPuppyContext.ToListAsync());
        }
