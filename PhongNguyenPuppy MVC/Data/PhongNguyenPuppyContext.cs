...
public partial class PhongNguyenPuppyContext : DbContext
{
    public PhongNguyenPuppyContext()
    {
    }

    public PhongNguyenPuppyContext(DbContextOptions<PhongNguyenPuppyContext> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-3KJ6M8N4\\SQLEXPRESS;Initial Catalog=PhongNguyenPuppy;Integrated Security=True;Trust Server Certificate=True");
